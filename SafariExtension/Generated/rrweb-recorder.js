(() => {
  // node_modules/.pnpm/@rrweb+record@2.1.1/node_modules/@rrweb/record/dist/record.js
  ...
  var BaseRRNode = class _BaseRRNode {
    ...
    contains(node) {
      if (!(node instanceof _BaseRRNode)) return false;
  ...
  // recorder-entry.js
  var STATE_KEY = "__pabloRRWebRecorderState";
  var MESSAGE = "pablo-rrweb";
